...
class adLDAP {
    ...
    */
    public function connect() {
        ...
        if ($this->_ad_username!=NULL && $this->_ad_password!=NULL){
            $this->_bind = @ldap_bind($this->_conn,/*Added by CAG*/$this->_account_prefix./*Done*/$this->_ad_username.$this->_account_suffix,$this->_ad_password);
            if (!$this->_bind){
    ...
    */
    public function close() {
		/*Added by CAG*/if( is_resource( $this->_conn ) )/*Done*/
    ...
    */
    public function authenticate($username, $password, $prevent_rebind = false) {
        ...
        // Bind as the user        
        $ret = true;
        $this->_bind = @ldap_bind($this->_conn, /*Added by CAG*/$this->_account_prefix . /*Done*/$username . $this->_account_suffix, $password);
